            ...
            <AnimatePresence>
               {filteredInstructors.map((inst, i) => (
                 <motion.div
                   ...
                   key={inst.id}
                   className="group bg-white dark:bg-zinc-900 border border-zinc-100 dark:border-zinc-800 rounded-[3.5rem] p-8 hover:border-teal-600/30 transition-all flex flex-col items-center text-center shadow-xl shadow-zinc-200/10 relative overflow-hidden"
                 >
                    {/* Brand Shard */}
                    ...
                    <div className="mb-6">
                       ...
                       <p className="text-[10px] font-black text-teal-600 uppercase tracking-[0.3em] font-mono mb-4 italic">{inst.expertise || "Institutional Faculty"}</p>
                    ...
                    <div className="w-full pt-8 border-t border-zinc-50 dark:border-zinc-800/50 flex flex-col gap-4 mt-auto">
                        ...
                        <Link href={`/instructors/${inst.id}`} className="mt-4 w-full py-4 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-2xl flex items-center justify-center gap-2 group/btn font-black text-[9px] uppercase tracking-[0.3em] italic shadow-xl shadow-zinc-950/10 hover:bg-teal-600 dark:hover:bg-teal-600 hover:text-white transition-all">
