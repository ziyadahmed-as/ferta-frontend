    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black pt-28 px-6 pb-24">
            <div className="max-w-4xl mx-auto">
                <div className="flex items-center gap-6 mb-16 px-10 py-12 bg-zinc-950 text-white rounded-[3.5rem] border border-zinc-900 shadow-2xl relative overflow-hidden group">
