                ...
                <div className="flex flex-col md:flex-row items-center gap-12 mb-16 px-8 py-12 bg-white dark:bg-zinc-900/50 rounded-[4rem] border border-zinc-100 dark:border-zinc-800 shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        <div className="flex items-center justify-center md:justify-start gap-4 mb-2">
                           ...
                           <span className="px-3 py-1 bg-teal-600/10 text-teal-500 border border-teal-600/20 rounded-lg text-[10px] font-black uppercase tracking-widest">{user.role}</span>
                        </div>
                        <p className="text-zinc-500 font-medium italic">Verified Scholar Node</p>
                    </div>

                    <button className="px-6 py-3 bg-zinc-900 dark:bg-white text-white dark:text-black rounded-2xl font-black text-xs uppercase tracking-widest flex items-center gap-2 hover:bg-teal-600 hover:text-white transition-all active:scale-95 shadow-xl">
