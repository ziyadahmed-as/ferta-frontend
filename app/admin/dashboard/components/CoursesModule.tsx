...
import { BookOpen, PlusCircle, Search, Filter, LayoutDashboard, Eye, Edit, Trash2, CheckCircle2, ShieldAlert, XCircle, Book, ChevronLeft, ChevronRight } from "lucide-react";
...
export const CoursesModule: React.FC<CoursesModuleProps> = ({
  ...
  const filteredCourses = allCourses.filter(c => courseSearch === "" || (c.title || "").toLowerCase().includes(courseSearch.toLowerCase()));
