      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            <Link href="/" className="flex items-center gap-2.5 mb-6 group">
              ...
              <span className="text-xl font-bold text-slate-900 dark:text-white">Fatra<span className="text-indigo-600"> Academy</span></span>
            </Link>
            ...
            <div className="flex items-center gap-3">
              {[Share2, MessageCircle, Globe, ExternalLink].map((Icon, i) => (
                <a key={i} href="#" title="Social link" className="w-9 h-9 bg-slate-50 dark:bg-zinc-900 hover:bg-indigo-600 dark:hover:bg-indigo-600 rounded-xl flex items-center justify-center text-slate-400 hover:text-white transition-all shadow-sm border border-slate-100 dark:border-zinc-800">
                  <Icon size={16} />
                </a>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full pl-4 pr-12 py-3.5 bg-slate-50 dark:bg-zinc-900 border border-slate-100 dark:border-zinc-800 rounded-xl text-sm text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:border-indigo-400 focus:bg-white dark:focus:bg-zinc-800 transition-all"
              />
        ...
        <div className="border-t border-slate-100 dark:border-zinc-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-3 text-xs text-slate-500 dark:text-slate-400">
          ...
          <div className="flex gap-5">
            <Link href="#" className="hover:text-indigo-600 dark:hover:text-white transition-colors">Terms of Service</Link>
            <Link href="#" className="hover:text-indigo-600 dark:hover:text-white transition-colors">Privacy Policy</Link>
            <Link href="#" className="hover:text-indigo-600 dark:hover:text-white transition-colors">Cookie Policy</Link>
          </div>
        </div>
      </div>
    </footer>
